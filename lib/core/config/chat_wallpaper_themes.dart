...
const List<ChatWallpaperTheme> kChatWallpaperThemes = <ChatWallpaperTheme>[
  ...
  ChatWallpaperTheme(
    id: 'cosmos',
    name: 'Космос',
    colors: [Color(0xFF0B1026), Color(0xFF1B2450), Color(0xFF2A1B4D)],
    pattern: '$_kPatternDir/cosmos.svg',
    patternOpacity: 0.09,
    tileSize: 180,
  ),
  ChatWallpaperTheme(
    id: 'cosmos_light',
    name: 'Космос светлый',
    colors: [Color(0xFFF2F4FC), Color(0xFFDFE6F8), Color(0xFFEBE4F7)],
    pattern: '$_kPatternDir/cosmos.svg',
    patternColor: Color(0xFF2A3566),
    patternOpacity: 0.07,
    tileSize: 180,
    dark: false,
  ),
